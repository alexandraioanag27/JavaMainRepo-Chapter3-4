...
public class Jellyfish extends Aquatic{
    ...
    public Jellyfish(int numberOfLegs, String name, int avgSwinDepth, Enum waterType) {
    ...
    public void encodeToXml(XMLEventWriter eventWriter) throws XMLStreamException
    {
        ...
        createNode(eventWriter, Constants.XML_TAGS.DISCRIMINANT, Constants.Animals.Aquatic.Jellyfish);
    }
